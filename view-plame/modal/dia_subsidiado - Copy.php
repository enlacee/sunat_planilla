...
/*
	for(x=0; x<master.length;x++){
		//eliminados = test.splice(x,1);
	console.log("eliminados");
	//console.dir(eliminados);
	alert("master "+master[x].id);
	
	test[x].id = "id"//master[x].id;
	test[x].descripcion = "descripcion"//master[x].descripcion;	
	}
*/
