...
} elseif ($op == "existe_persona") {
    $cod_tipo_documento = $_REQUEST['tipo_documento'];
    $num_doc = $_REQUEST['num_documento'];
    //echo "EM ".ID_EMPLEADOR_MAESTRO;
    $response = existePersonaRegistrada(ID_EMPLEADOR_MAESTRO, $num_doc, $cod_tipo_documento);
} else {
...
function registrarPersonaAntesRegistrada($ID_PERSONA){
    ...
    return nuevoTrabajador($ID_PERSONA);
...
function nuevaPersona() {
    ...
    $estado = existePersonaRegistrada(ID_EMPLEADOR_MAESTRO, $_REQUEST['txt_num_documento'], $_REQUEST['cbo_tipo_documento']);

    //echo "estadooo   exite ".$estado;
