          ...
          <form action="" method="post" name="form_edit_establecimiento" id="form_edit_establecimiento" novalidate="novalidate">
            <fieldset>
                    <div class="ocultar">
                      ...
                      <div class="fila_input ocultar"> <input name="oper" type="text" value="edit" /></div>
                      
                      
                      <div class="fila_input"><label>id_empleador</label>
                        <input name="id_empleador" type="text" 
					value="<?php echo $obj_establecimiento->getId_empleador(); ?>"></div>
                      
                      <div class="fila_input"><label>id_establecimiento</label>
                        <input name="id_establecimiento" type="text" 
					value="<?php echo $obj_establecimiento->getId_establecimiento(); ?>"></div>
                    </div>
