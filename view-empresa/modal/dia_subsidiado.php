...
//DATOS
$data = buscarDiaSPor_IdPago($id_pago);
        ...
        <table width="450" border="1" id="tb_dsubsidiado">
            ...
            for ($i = 0; $i < count($data); $i++):
                ...
                <tr id="dia_subsidiado-<?php echo $ID;?>">
                    ...
                    <td>
                        <span title="editar">
                            <a href="javascript:editar_ds('<?php echo $ID; ?>',<?php echo $data[$i]->getId_pdia_subsidiado(); ?>)">
                    ...
                    <td>
                        <span title="editar">
                            <a href="javascript:eliminar_ds( 'dia_subsidiado-<?php echo $ID; ?>',<?php echo $data[$i]->getId_pdia_subsidiado(); ?> )">
