...
//FUNNCION CARGAR_TABLA PASARELAS 10/12/2011
function cargarTablaDetalleConcepto(id_concepto){ 
	//$("#list").jqGrid('GridUnload');
	$("#list").jqGrid({
		url:'sunat_planilla/controller/PlameDetalleConceptoController.php?oper=cargar_tabla&id_concepto='+id_concepto,
		datatype: 'json',
		colNames:['Codigo','Cod-Concepto','Descripcion','Afectaci&oacute;n'],
		colModel :[
			{
